// Adapted from gum-1's KaTeX symbol table; see THIRD_PARTY_NOTICES.md.
import type { SymbolMode, SymbolFont, SymbolFamily, SymbolEntry } from './types'
...
const symbols: Record<SymbolMode, Record<string, SymbolEntry>> = {
    "math": {},
    "text": {},
}
...
// modes:
const math: SymbolMode = "math"
const text: SymbolMode = "text"

// fonts:
const main: SymbolFont = "main"
...
const ligatures: Record<string, boolean> = {
    "--": true,
    "---": true,
    "``": true,
    "''": true,
